...
<div class="container-fluid">     
    ...
    <div class="row ">
        <div class="card justify-content-center align-items-center">
            <div class="col-xl-8">
                <div class="auth-form ">
                    <form action="{{route('rupdate',$region->id)}}" method="POST">
                    @csrf
                    @method('PUT')
                        <div class="row mb-3">
                            <label class="col-md-4 col-form-label text-md-end"><strong>Zone Code</strong></label>
                            <div class="col-md-6">
                                <input type="text" name="zCode" class="form-control" value="{{$region->zCode}}">
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label class="col-md-4 col-form-label text-md-end"><strong>Region Code</strong></label>
                            <div class="col-md-6">
                                <input type="text" name="rCode" class="form-control" value="{{$region->rCode}}">
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label class="col-md-4 col-form-label text-md-end"><strong>Region Name/strong></label>
                            <div class="col-md-6">
                                <input type="text" name="rName" class="form-control" value="{{$region->rName}}">
                            </div>
                        </div>                 
                        <div class="row mb-3">
